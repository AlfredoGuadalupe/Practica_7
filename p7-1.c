...
int main(){
	...
	unsigned int v_2;//variable de tipo entero sín signo
	long v_3;//variable de tipo long con signo 
	signed long a;//variable de tipo long con signo
	unsigned long b;//variable de tipo long sín signo	
	signed short c;//variable de tipo short con signo
	unsigned short d;//variable de tipo short sín signo
